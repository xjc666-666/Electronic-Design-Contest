...
#define LMX2571_FDV_1 GPIO_SetBits(GPIOC, GPIO_Pin_0)
#define LMX2571_FDV_0 GPIO_ResetBits(GPIOC, GPIO_Pin_0)

#define LMX2571_FD0_1 GPIO_SetBits(GPIOC, GPIO_Pin_1)
#define LMX2571_FD0_0 GPIO_ResetBits(GPIOC, GPIO_Pin_1)

#define LMX2571_FD1_1 GPIO_SetBits(GPIOC, GPIO_Pin_2)
#define LMX2571_FD1_0 GPIO_ResetBits(GPIOC, GPIO_Pin_2)

#define LMX2571_FD2_1 GPIO_SetBits(GPIOC, GPIO_Pin_3)
#define LMX2571_FD2_0 GPIO_ResetBits(GPIOC, GPIO_Pin_3)

#define LMX2571_TRCTL_1 GPIO_SetBits(GPIOC, GPIO_Pin_5)
#define LMX2571_TRCTL_0 GPIO_ResetBits(GPIOC, GPIO_Pin_5)

#define LMX2571_CLK_1 GPIO_SetBits(GPIOC, GPIO_Pin_6)
#define LMX2571_CLK_0 GPIO_ResetBits(GPIOC, GPIO_Pin_6)

#define LMX2571_LE_1 GPIO_SetBits(GPIOC, GPIO_Pin_7)
#define LMX2571_LE_0 GPIO_ResetBits(GPIOC, GPIO_Pin_7)

#define LMX2571_DATA_1 GPIO_SetBits(GPIOB, GPIO_Pin_4)
#define LMX2571_DATA_0 GPIO_ResetBits(GPIOB, GPIO_Pin_4)

#define LMX2571_CE_1 GPIO_SetBits(GPIOB, GPIO_Pin_5)
#define LMX2571_CE_0 GPIO_ResetBits(GPIOB, GPIO_Pin_5)
